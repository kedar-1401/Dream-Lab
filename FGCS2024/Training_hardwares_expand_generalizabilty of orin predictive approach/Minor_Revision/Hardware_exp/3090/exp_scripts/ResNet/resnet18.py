 ...
 #   print(summary(model, (3,28,28), 16))
    ...
    for _ in range(num_epochs):
        ...
        for batch_idx, (images, labels) in enumerate(train_loader):
            ...
            epoch_fname.info(str(_) + "," + "null" + "," + "\"" + ":" + "\"" + "," + "null" +"," + str(start1.elapsed_time(end1)) + "," + str(time.time() - reference_time))
...
#     with open(file_prefix+'_swap_stats.csv', 'w',
...
#         writer.writerow(['total', 'used', 'free', 'log_time'])
    ...
    try:
        main(dataset_outer_folder, num_workers, prefetch_factor, logger_e2e,
             logger_fetch, logger_compute, None, reference_time, batch_size)
        # main(dataset_outer_folder, num_workers, prefetch_factor, None,
        #      None, None, None, reference_time, batch_size)
    except ():
