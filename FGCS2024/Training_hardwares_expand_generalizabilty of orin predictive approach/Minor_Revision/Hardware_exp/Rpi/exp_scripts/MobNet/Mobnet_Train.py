...
def train(net, trainloader,testloader, epoch_fname, fetch_fname, compute_fname, vmtouch_fname, dataset_outer_folder, reference_time, epochs):
    ...
    for _ in range(num_epochs):       
        ...
        for batch_idx, (images, labels) in enumerate(trainloader):
            ...
            fetch_fname.info(f"{_},{batch_idx},null,{fetch_time},{time.time() - reference_time}")
            compute_fname.info(f"{_},{batch_idx},null,{compute_time},{time.time() - reference_time}")
            epoch_fname.info(f"{_},null,: ,null,{epoch_time},{time.time() - reference_time}")
