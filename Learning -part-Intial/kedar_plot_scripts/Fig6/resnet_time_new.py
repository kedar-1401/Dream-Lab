...
ax1.text(110, 72, '14.8h*', color='purple', fontsize=12, ha='center', va='center', rotation=90)
...
plt.legend(handles=handles[-3:], labels=labels[-3:], loc='upper left',bbox_to_anchor=(0.2, 1))
