...
def plot_MAPE_dc_violins_power(name):
    df=pd.read_csv(name)
    #x axis is no of sampled powermodes
    #y axis is MAPE
    #violin plot for each sample count
...
sample_count_list=[50,40,30,20,10]
no_runs=10
...
name = "train_data.csv"
pretrained_model_weights_path_time = 'NN_resnet_time_80_10_10.h5'
pretrained_model_weights_path_power = 'NN_resnet_power_80_10_10.h5'
...
plot_MAPE_dc_violins("NN_loop_transfer.csv")
plot_MAPE_dc_violins_power("NN_loop_transfer_power.csv")
